...
redirect [format "%s%s"  [format "%s%s"  [format "%s%s"  $report_dir $design_name] $tech_lib] "_power_pt.rpt"] { report_power -verbose }
redirect -append [format "%s%s"  [format "%s%s"  [format "%s%s"  $report_dir $design_name] $tech_lib] "_power_pt.rpt"] { report_power -hier -verbose }
