...
set hfo_nets [list "clk" "reset" "scan_en"]
...
current_design $design_name
set_false_path -from [list reset scan_en]
set_driving_cell  -lib_cell DFFX1  -pin Q -library typical [list [remove_from_collection [all_inputs] [list clk reset scan_en]]]
set_input_delay $INPUT_DELAY -clock clk [list [remove_from_collection [all_inputs] [list clk reset scan_en]]]
set_input_delay 0 -clock clk [list clk reset scan_en]
