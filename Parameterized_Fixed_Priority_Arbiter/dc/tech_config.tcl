...
set tsmc18 "/classes/ee620/maieee/lib/tsmc-0.18/synopsys"
...
set search_path [list . [format "%s%s"  $synopsys_root "/libraries/syn"] $tsmc18 $tsmc065 $SAED_EDK32nm $SAED_EDK90nm ./include ./src]
...
if {$tech_lib == $saed32nm_tech_lib} {
  ...
  set library_file $saed32nm_library_name
}
